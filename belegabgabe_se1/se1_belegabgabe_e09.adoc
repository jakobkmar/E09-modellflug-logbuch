...
// --- 2. Teammitglieder -----------------------
Lucas Trogisch <lucas.trogisch@stud.htw-dresden.de>; Jakob Kretzschmar <jakob.kretzschmar@stud.htw-dresden.de>; Julian Neidert <julian.neidert@stud.htw-dresden.de>; Felix Glieme <felix.glieme2@stud.htw-dresden.de>; Laurin Wobeda <laurin.wobeda@stud.htw-dresden.de>; Conrad Caffier <conrad.caffier2@stud.htw-dresden.de>; Abdallah Alherani <abdallah.alherani@stud.htw-dresden.de>
// --- 3. Abgabedatum --------------------------
26. Januar 2024
// ---------------------------------------------
:docs: ../docs
