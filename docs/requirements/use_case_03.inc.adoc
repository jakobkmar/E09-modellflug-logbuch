...
==== Pilot
Der Akteur Pilot kann nach dem Anmelden ein Protokoll anlegen.
...
.Use-Case_Diagramm: UC03ProtokollAnlegen
[plantuml, "{diagramsdir}/UC03ProtokollAnlegen", svg]
....
@startuml
left to right direction
"Pilot" as ac02
package Webapp-Frontend {
    "UC03 Protokoll wird angelegt" as (uc03)
}
