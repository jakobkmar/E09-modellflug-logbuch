...
* problematisch dabei ist, dass der Gesetzgeber mittlerweile eine digitale Lösung fordert
...
** es gibt ca. 3 Administratoren 
** Anzahl der Admins ändert sich im Laufe der Zeit eher nicht
...
** darf seine persönlichen Daten einsehen
