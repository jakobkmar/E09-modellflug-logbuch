...
| Logbuch | 21 | mobiles, elektronisches Logbuch | xx
| Administration |  5 | Administrator kann Nutzer bearbeiten und Webapp pflegen und bearbeiten | xx
| Webserver | 21 | Webserver auf dem proxmox Server des Vereins | xx
| Synchronität | 13  | Synchronisation zwischen Smartphone und Webserver | xx
| benutzer-Oberfläche | 21 | Benutzeroberfläche, über die sich Piloten ein- und austragen können | xx
| Datenbank | 21 | Datenbank zur Speicherung und Verwaltung der Logbuchdaten | xx
| sichere Kommunikation | 13  | sichere Kommunikation zwischen mobilen Endgeräten und Webserver sowie Schutz der Daten | xx
| Admin-Benutzeroberfläche | 5  | Benutzeroberfläche und Backend-Logik zur Verwaltung des Logbuchs | xx
| Login/Authentifizierung | 5  | Login/Authentifizierung | xx
| 2FA | 3  | 2-Faktor-Authentifizierung | xx
| Zugriffskontrolle | 2  | rollenbasierte Zugriffskontrolle | xx
| Passwortrichtlinien | 2  | Passwortrichtlinien | xx
| Authentifizierungsprotokolle | 1  | Authentifizierungsprotokolle | xx
| Sessionverwaltung | 1  | Sessionverwaltung | xx
| Wiederherstellungsmöglichkeiten | 1  | Wiederherstellungsmöglichkeiten | xx
| Internationalität | 5  | Sprache Deutsch                                                        | xx
| Internationalität | 5  | Sprache Englisch                                                       | xx
| Wetteransage | 2  | Wetterdaten werden automazisch erfasst sobald Wetterstation online ist | xx
| Backend | 8  | Funktionierendes Backend                                               | xx
| Frontend | 8  | Funktionierendes Frontend                                              | xx
|===
...
| Webapp kann auf Deutsch oder Englisch angezeigt werden | mittel | xx
...
| Offline Eintragungen von Daten in das Logbuch | gering | xx
| Grafana wird benötigt, um Wetterdaten grafisch darzustellen | gering | xx
|===
