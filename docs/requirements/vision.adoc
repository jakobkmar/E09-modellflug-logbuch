...
| betrifft | ... die Piloten, die Verwaltung und Gäste des Modelflugplatz, die Verwaltung
| die Auswirkung davon ist | ... ein hoher Stromverbrauch an einer Stelle an der es kritisch ist und teilweise umständliches Loggen von Piloten und Flügen.
...
|   | Piloten des Flugplatz  |   
|   | Verwaltung des Flugplatz  | 
|   | Gäste auf dem Flugplatz  |     
|   | Verwaltung des Ort Rossendorf  |   
|   | Entwickler des Produkt  |   
|   |   |   
|===
