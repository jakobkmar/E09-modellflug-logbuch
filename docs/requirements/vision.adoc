...
| extern  | Gemeinde des Ort Rossendorf  | könnte bei Einsicht profitieren (von zB der Übersichtlichkeit); geringerere Stromverbrauch ist auch für Gemeinde von Vorteil 
| intern  | Entwickler des Produkt/Studenten  | wollen SE bzw. Beleg bestehen; übersichtlicher Aufwand  
...
| xx | 10 | Datenbank zur Speicherung und Verwaltung der Lugbuchdaten | xx
