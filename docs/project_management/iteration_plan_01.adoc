...
* Erstellung von github repository
...
| Einrichtung einer gemeinsamen Kommunikationsplattform | x | 2 | 100% | x | 1 | Lucas | 1 | 0 
| Rollenfindung | x | 1 | 100% | x | 1 | Alle | 1 | 0 
| Erstellung von github repository | x | ? | 100% | x | 1 | Jakob | ? | 0 
| Kontaktaufnahme mit Auftraggeber und Coach | x | 1 | 100% | x | 1 | Lucas | 1 | 0 
| Terminvereinbarungen | x | 1 | 100% | x | 1 | Alle | 1 | 0 
| Bearbeitung Iteration Plan  | x | 1 | 100% | x | 1 | Lucas | 1 | 0 
| Bearbeitung Vision  | x | 120 | ? | x | 1-X | Analyse | 1 | ?
| Einarbeitung in die fachlichen Bereiche des OpenUP  | x | 120 | ? | x | 1-2 | Alle | 1 | ?
| Planung Teambuilding Event  | x | 4 | 50% | x | 1-2 | Alle | 1 | 1
|===
