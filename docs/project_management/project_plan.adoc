...
Bei der Vereinbarung von Terminen mit dem Auftraggeber kam es zu Missverständnissen, und dadurch zu Verzögerungen im Arbeitsablauf sowie allgemeinen Unmut. 
Um dies in Zukunft zu vermeiden wurde vereinbart noch im bestehenden Meeting den kommenden Termin fix zu vereinbaren - inklusive Kalendernotiz - um künftigen Informationsdefiziten vorzubeugen. 

=== Meetings 
Meetings sollten besser Strukturiert und geplant werden um die Effizienz zu verbessern. Die chronische Abwesenheit eines Teammitglieds führte darüber hinaus zu Abstimmungsschwierigkeiten
