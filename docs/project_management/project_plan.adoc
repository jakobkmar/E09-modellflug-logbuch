...
Das Projekt orientiertsich am Prinzip des Risk-Value Lifecycle Prinzips, durch die Einteilung des Projektes in Inception-,	Elaboration-,	Construction- und	Transition-Phase.
Der Übergang zwischen dan Phasen ist durch das erreichen Spezifuscher Meilensteine gekennzeichnet, dabei ist jedoch im Vergleich zum Wasserfall Modell mit dem erreichen eines Meilensteines die Vorangegeangene Phase nich abgeschlossen, sondern markiert lediglich die Bereitschaft das Projekt weiterzuentwickeln. Die Trennung des Projektes in einzelne Phasen ist für einee Zielorientierte Strukturierung des Projektes hilfreich. 

Des weiteren wurde für dieses Projekt ein Projektplan geschrieben, der Arbeitsweisen und Praktiken in der Projektentwicklung sowie etwaige Erkenntnisse zentral Dokumentiert und damit als Hilfsmittel und Nachschlagewerk für alle Teammitglieder im Projekt, sowie als Fallbeispiel für zukümftige Projekte dienen kann. 

Um als Team effektiv zusammenzuarbeiten ist es erforderlich Arbeiten zuzuweisen und den Arbeitsfortschritt zu überwachen. Gerade der Kontext der Projekterfüllung als eine Aufgabe von vielen, in Teilzeit, erfordert Zuverlässigkeit und Vaerantwortungsewusstsein für den Erfolg des Teams von allen Mitgliedern. Das durchführen von Teambuildingevents sowie regelmäßige Kommunikation in Meetings, sollen das bewusstsein für die eigene Verantwortung für das ganze Team stärken. Arbeiten werden nicht autoritär vergeben. Sattdessen werdne Aufgabenpake in Meetings definiert und von den einzelnen teammitgliedern nach eigenem Vermögen und persönlichen Kapazitäten angenommen. 
