    ...
    <fieldset class="form-fieldset">
      ...
      <div style="display: flex; gap: 0.5em; align-items: end;">
        <div class="column" style="align-items: center; gap: 0.1em">
          <input type="time" v-model="startTimeInput" class="form-control" style="min-width: 8em; text-align: center;">
          <div style="font-size: 0.8em;">von</div>
        </div>
        <div class="column" style="align-items: center; gap: 0.1em">
          <input type="time" v-model="endTimeInput" class="form-control" style="min-width: 8em; text-align: center;">
